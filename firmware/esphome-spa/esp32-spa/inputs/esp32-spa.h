...
#include "esphome/components/text_sensor/text_sensor.h"  // full TextSensor definition: publish_state() is called below, a forward declaration isn't enough on current ESPHome
#include <string>
#include <utility>

// Forward-declare binary sensor to avoid requiring its header at this point
